package com.tdu.simple.annotation;
...
public @interface Cacheable  {
	 ...
	 * for a reference to the {@link java.lang.reflect.Method method}, target
	 ...
	 * argument can be access via {@code #root.args[1]}, {@code #p1} or
	 ...
	 * following meta-data:
	 * <ul>
	 * <li>{@code #result} for a reference to the result of the method
	 * invocation.</li>
	 * <li>{@code #root.method}, {@code #root.target} and {@code #root.caches}
	 * for a reference to the {@link java.lang.reflect.Method method}, target
	 * object and affected cache(s) respectively.</li>
	 ...
	 * @return
	 */
	String applicationName() default "Sys";
